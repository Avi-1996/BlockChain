...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 15:50:56 2019
...
class Blockchain:
    ...
    def create_block(self,proof,previous_hash):
       ...
       # hash_code = self.hash(block)
        ...
        return block                  
    def add_transection(self,sender,receiver,amount):
        self.transections.append({'sender' : sender,
                                  'receiver' : receiver,
                                  'amount' : amount})
        prevoious_block = self.get_previous_block();
